...
function ispam_blocked () {
	...
	<div class="wrap">
		...
		<?php endif; ?>
		</br><h3 class="update-nag">Please visit our own <a href="https://hardani.de/ispam/" target="_blank">support team</a> for any issuses.</h3>		
		</br><h3 class="update-nag">Keyvan Hardani</h3>
	</div>
